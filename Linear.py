...
if __name__ == "__main__":
    ...
    ax2.plot(t_all, traj_lr[:, 0], "b-", label="Linear X")
    ax2.set_title("X")
    ax2.legend()
    ax2.grid()
    fig2.savefig(r"C:\Users\86134\Desktop\drone\results\figures\linear_x.png", dpi=150, bbox_inches="tight")
    plt.show()
    ...
    ax3.plot(t_all, traj_lr[:, 1], "b-", label="Linear Y")
    ax3.set_title("Y")
    ax3.legend()
    ax3.grid()
    fig3.savefig(r"C:\Users\86134\Desktop\drone\results\figures\linear_y.png", dpi=150, bbox_inches="tight")
    plt.show()
    ...
    ax4.plot(t_all, traj_lr[:, 2], "b-", label="Linear Z")
    ax4.set_title("Z")
    ax4.legend()
    ax4.grid()
    fig4.savefig(r"C:\Users\86134\Desktop\drone\results\figures\linear_z.png", dpi=150, bbox_inches="tight")
    plt.show()